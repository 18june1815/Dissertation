...
\subsection{Кварк-Глюонная плазма}

\begin{frame}
	\frametitle{Кварк-глюонная плазма}
    \begin{minipage}[c]{0.605\linewidth}
		\center{\includegraphics[width=1\linewidth]{Presentation/images/BigBang.png}}
		%\textbf{Составная \\ подпись 1}
	\end{minipage}
	\begin{minipage}[c]{0.385\linewidth}
		\flushright
		\center{\includegraphics[width=1\linewidth]{Presentation/images/QGP_HI.png}}
		%\textbf{Составная \\ подпись 2}
	\end{minipage}
\end{frame}

\subsection{Адронизация КГП}
\begin{frame}
	\frametitle{Адронизация КГП}
	\begin{minipage}[c]{0.605\linewidth}
		\center{\includegraphics[width=1\linewidth]{Presentation/images/BigBang.png}}
		%\textbf{Составная \\ подпись 1}
	\end{minipage}
...
\subsection{Заряженные адроны}
\begin{frame}
	\frametitle{Заряженные адроны}
	\begin{minipage}[c]{0.605\linewidth}
		\center{\includegraphics[width=1\linewidth]{Presentation/images/BigBang.png}}
		%\textbf{Составная \\ подпись 1}
	\end{minipage}
...
\begin{frame}
    ...
    \centering
    \includegraphics[width=0.8\linewidth]{Intro/AMPT.png} % окружение figure не требуется
\end{frame}
\begin{comment}
\begin{frame}
...
\begin{frame}
    ...
    \centering
    \vfill
    \includegraphics[width=0.8\linewidth,height=0.1\textheight]{Intro/AMPT.png} \\
    \TeX
    \vfill
    \includegraphics[width=0.8\linewidth,height=0.2\textheight]{Intro/AMPT.png} \\
    \LaTeX
    \vfill
    \includegraphics[scale=0.2]{Intro/AMPT.png} \\
    \vfill
\end{frame}
...
\begin{frame}
    ...
    \begin{minipage}[t]{0.47\linewidth}
        \textbf{Составная \\ подпись 1}
        \center{\includegraphics[width=1\linewidth]{Intro/AMPT.png}}
    \end{minipage}
    \hfill
    \begin{minipage}[t]{0.47\linewidth}
        \textbf{Составная \\ подпись 2}
...
\begin{frame}
    ...
    \centering
    \includegraphics[width=0.35\linewidth,angle=35]{Intro/AMPT.png}
    \includegraphics[width=0.35\linewidth,angle=135]{Intro/AMPT.png}\\
    \includegraphics[width=0.35\linewidth,angle=15]{Intro/AMPT.png}
    \includegraphics[width=0.35\linewidth,angle=-15]{Intro/AMPT.png}
\end{frame}
